...
/**
 * Tester class to test GenericCollections
 *
 * @author Ronan Ballantine
 */
public class GenericCollectionsTester1 {
    public static void main(String[] args) {
        ...
        GenericCollections.rotate(myList, 4);
        printList("\nList rotated by 4:", myList);
        GenericCollections.rotate2(myList, -2);
        printList("\nList rotated by minus two using rotate2 method:", myList);
        System.out.println("\nThe oldest person is: \n" + GenericCollections.max(myList));
    }
